...
betas_distribution_c(features_or_ikem,  relevant_ics_ikem, path_ikem, no_hc_ikem)
...
# plot the distribution of beta values for selected ICs
betas_distribution_c(features_or_nudz,  relevant_ics_nudz, path_nudz, no_hc_nudz)

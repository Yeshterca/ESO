...
dataset = 'ikem'
print(dataset)
no_subjects_ikem, no_hc_ikem, no_fes_ikem, relevant_ics_ikem, no_features_ica_ikem, directory_ica_ikem = set_vars(dataset)
...
print('\n')
print(dataset)
no_subjects_nudz, no_hc_nudz, no_fes_nudz, relevant_ics_nudz, no_features_ica_nudz, directory_ica_nudz = set_vars(dataset)
